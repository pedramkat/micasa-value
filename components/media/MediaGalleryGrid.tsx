...
import type { MediaPhoto } from "./MediaPreviewDialog"

interface MediaGalleryGridProps {
  photos: MediaPhoto[]
  selected: Set<string>
  onToggleSelect: (id: string) => void
  onPreview: (photo: MediaPhoto) => void
  onDelete: (photo: MediaPhoto) => void
}

export function MediaGalleryGrid({ photos, selected, onToggleSelect, onPreview, onDelete }: MediaGalleryGridProps) {
  const [deleteTarget, setDeleteTarget] = useState<MediaPhoto | null>(null)
