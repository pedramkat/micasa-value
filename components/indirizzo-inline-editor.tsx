...
export function IndirizzoInlineEditor({ initialValue, onSave }: Props) {
  ...
  return (
    <div className="rounded-lg bg-gray-50 px-4 py-3 ring-1 ring-gray-100">
      <div className="text-xs font-semibold uppercase tracking-wide text-gray-500">Indirizzo</div>
      ...
      {isEditing ? (
        ...
        <button
          ...
          className="mt-1 block w-full rounded-md bg-white px-3 py-2 text-left text-sm font-semibold text-gray-900 ring-1 ring-gray-200 hover:bg-gray-50"
        >
